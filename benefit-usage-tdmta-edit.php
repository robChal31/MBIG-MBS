...
<?php
    $id_tdmta=$_GET['id'];
    $sql = "SELECT * from op_tdmta where id_tdmta='$id_tdmta'";
                ...
                <script type='text/javascript'>
                    ...
                    var str = selectObject.value;  
                      if (str.length == 0) {
                        ...
                        xmlhttp.open("GET", "cekquota.php?type=4&idm=" + str+"&time="+time_stamp, true);
                        xmlhttp.send();
                      }
                    }
                </script>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <form method="POST" action="benefit-usage-tdmta-edit-action.php" enctype="multipart/form-data">
                            <h6 class="mb-4">School Benefit Usage - TDMTA</h6>
                            ...
                            <div class="form-floating mb-3">
                                <input type="date" class="form-control" id="tanggal" name="tanggal" <?php if($id_tdmta>0){echo "value='".$rowa['training_date']."'";} ?>
                                    placeholder="Tanggal Training Training" required>
                                <label for="description">Tanggal Training</label>
                            </div>

                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="description" name="description" <?php if($id_tdmta>0){echo "value='".$rowa['description']."'";} ?>
                                    placeholder="Training Description" required>
                                <label for="description">Description</label>
                            </div>
                            
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="nama_peserta" name="nama_peserta" <?php if($id_tdmta>0){echo "value='".$rowa['nama_peserta']."'";} ?>
                                    placeholder="Nama peserta">
                                <label for="description">Nama Peserta</label>
                            </div>
                            <div class="form-floating mb-3" id="containerss"> </div>
                            <input type='hidden' name='id_tdmta' value='<?=$id_tdmta?>'>
