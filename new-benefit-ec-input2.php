                          ...
                          <tbody>
                            <?php if(($current_row == 1 && !ISSET($_GET['edit'])) || ($current_row < 1 && ISSET($_GET['edit']))): ?>
                              <tr id="row<?= $current_row ?>">
                                  <td>
                                    <span name="benefit"><?= ucfirst($program); ?> Benefit</span>
                            ...
                            <?php else:
                              ...
                              while ($data = $result->fetch_assoc()): ?>
                                <tr id="row<?= $x; ?>">
                                  <td>
                                    <span name="benefit"><?= $data['type'] ?></span>
