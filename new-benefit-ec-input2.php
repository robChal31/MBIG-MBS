                            ...
                            while ($data = $result->fetch_assoc()): ?>
                              <tr id="row<?= $x; ?>">
                                ...
                                ?>
                                  ...
                                  <td>
                                    <input type="number" class="form-control form-control-sm tah1" id="member" name="member[]" placeholder="Quantity Tahun 1" value="<?= $data['qty'] ?>" min="0" onchange="updateDisabledField(this)" onload="updateDisabledField(this)" <?php if($data['editable_qty'] == '0'){echo "disabled";} ?>>
                                  </td>
                                  <td>
                                    <input type="number" class="form-control form-control-sm tah2" id="member2" name="member2[]" placeholder="Quantity Tahun 2" value="<?= $data['qty2'] ?>" min="0" onchange="updateDisabledField(this)" onload="updateDisabledField(this)" <?php if($program=='cbls1'|| $program=='cbls3' || $program=='bsp' || $data['editable_qty'] == '0'){echo "disabled";} ?> >
                                  </td>
                                  <td>
                                    <input type="number" class="form-control form-control-sm tah3" id="member3" name="member3[]" placeholder="Quantity Tahun 3" value="<?= $data['qty3'] ?>" min="0" onchange="updateDisabledField(this)" onload="updateDisabledField(this)" <?php if($program=='cbls1'|| $program=='cbls3' || $program=='bsp' || $data['editable_qty'] == '0'){echo "disabled";} ?>>
                                  </td>
                                  <td>
