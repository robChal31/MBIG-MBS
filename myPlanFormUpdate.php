...
?>
    <div class="p-2">
        ...
        <h6 class="mt-4 mb-2">Add your Plan Here</h6>

        <form action="save-pk.php" method="POST" enctype="multipart/form-data" id="form-id">
          <div class="row">
            <div class="col-12 mb-3">
                <label class="form-label">Inform Your Update Plan</label>
                <textarea name="update_note" class="form-control" style="height: 150px;"><?= $update ?></textarea>
            </div>

            <div class="col-md-7 col-12 mb-3">
                <label class="form-label">Added At</label>
                <input type="date" name="added_at" class="form-control form-control-sm" value="<?= $added_at ?>" required>
            </div>
