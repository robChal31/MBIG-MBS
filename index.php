...
<head>
    <meta charset="utf-8">
    <title>Benefit - Mentari Groups Benefit Dashboard</title>
...
<body>
    <div class="container-xxl position-relative card d-flex p-0">
        <!-- Spinner Start -->
        <div id="spinner" class="show card position-fixed translate-middle w-100 vh-100 top-50 start-50 d-flex align-items-center justify-content-center">
                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-3">
                             <img src="img/logoMISs.png" style="width:40%">
                            <h3>Sign In</h3>
                        </div>
