                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="table_id">
                                    ...
                                    <tbody>
                                        <?php 
                                            $sql = "SELECT b.school_name, b.jenDok,c.ec_name,b.date,b.year,b.title,a.mbmta1,a.mbmta2,a.mbmta3, sum(jumlah_peserta) as jum FROM `op_mbmta` a left join op_masterdata b on a.id_master=b.id_master left join dash_ec c on c.id_ec=b.id_ec group by a.id_master";
