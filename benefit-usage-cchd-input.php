...
<?php
    $id_cchd=$_GET['id'];
    $sql = "SELECT * from op_cchd where id_cchd='$id_cchd'";
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <form method="POST" action="benefit-usage-cchd-input-action.php" enctype="multipart/form-data">
                            <h6 class="mb-4">School Benefit Usage - CCHD</h6>
                            <div class="form-floating mb-3">
                                <select class="form-select" data-role="select" id="id_master" name="id_master" placeholder="Nama Sekolah"
                                    ...
                                    <?php
                                        $sql="select b.id_master,b.school_name,b.year from op_benefit a left join op_masterdata b on a.id_master=b.id_master where a.approval=1 and a.id_benefittype=9 order by school_name ASC";
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <label for="description">Description CCHD</label>
                            </div>
                            ...
                            <?php
                                if($id_cchd>0)
                                {
                                    ...
                                    echo "<input type='hidden name='id_cchd' value='".$id_cchd."'>";
                                }
                            ?>
