<?php include 'header.php'; ?>
        ...
        <div class="content">
            ...
            <!-- Navbar End -->
             <?php
    $id_supervisi=$_GET['id'];
    $sql = "SELECT * from op_supervisi where id_supervisi='$id_supervisi'";
                ...
                <script type='text/javascript'>
                    ...
                    var str = selectObject.value;  
                      if (str.length == 0) {
                        ...
                        xmlhttp.open("GET", "cekquota.php?type=11&idm=" + str+"&time="+time_stamp, true);
                        xmlhttp.send();
                      }
                    }
                </script>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <form method="POST" action="benefit-usage-supervisi-input-action.php" enctype="multipart/form-data">
                            <h6 class="mb-4">School Benefit Usage - Supervisi</h6>
                            <div class="form-floating mb-3">
                                <select class="form-select" data-role="select" id="id_master" name="id_master" placeholder="Nama Sekolah"
                                    ...
                                    <?php
                                        $sql="select b.id_master,b.school_name,b.year from op_benefit a left join op_masterdata b on a.id_master=b.id_master where a.approval=1 and a.id_benefittype=11 order by school_name ASC";
                            ...
                            <div class="form-floating mb-3">
                                <input type="date" class="form-control" id="tanggal" name="tanggal" <?php if($id_supervisi>0){ echo "value='".$rowa['date_spv']."'";} ?>
                                    placeholder="Tanggal Supervisi">
                                <label for="description">Tanggal Supervisi</label>
                            </div>
                            
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="description" name="description" <?php if($id_supervisi>0){ echo "value='".$rowa['description']."'";} ?>
                            ...
                            <?php
                                if($id_supervisi>0)
                                {
                                    echo "<input type='hidden' name='id_supervisi' value='".$id_supervisi."'>";
