<?php
    ...
    echo $description;
    $sql = "select id_benefit from op_benefit where id_master='$id_master' and id_benefittype=15 and approval=1 and qty>0";
    ...
    for($i = 0; $i<$member ; $i++)
    {
       $sql = "INSERT INTO `op_s2` (`id_s2`, `id_master`, `training_date`, `nama_peserta`, `status`,`description`) VALUES 
