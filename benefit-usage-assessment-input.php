                ...
                <script type='text/javascript'>
                    ...
                    var str = selectObject.value;  
                      if (str.length == 0) {
                        ...
                        xmlhttp.open("GET", "cekquota.php?type=6&idm=" + str+"&time="+time_stamp, true);
                        xmlhttp.send();
                      }
                    }
                </script>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <form method="POST" action="benefit-usage-assessment-input-action.php" enctype="multipart/form-data">
                            <h6 class="mb-4">School Benefit Usage - Assessment</h6>
                            <div class="form-floating mb-3">
                                <select class="form-select" data-role="select" id="id_master" name="id_master" placeholder="Nama Sekolah"
                                    ...
                                    <?php
                                        $sql="select b.id_master,b.school_name,b.year from op_benefit a left join op_masterdata b on a.id_master=b.id_master where a.approval=1 and a.id_benefittype=6 order by school_name ASC";
                            ...
                            <div class="form-floating mb-3">
                                <select class="form-select" data-role="select" id="id_template_benefit" name="id_template_benefit" placeholder="Pilih Benefit"
                                    ...
                                    <?php
                                        $sql="select * from op_template_benefit where benefit='Assessment'";
                                        if($result = mysqli_query($conn,$sql))
                                        {
                                            while($row = mysqli_fetch_assoc($result))
                                            {
                            ...
                            <div class="form-floating mb-3">
                                <input type="date" class="form-control" id="tanggal" name="tanggal"
                                    placeholder="Tanggal Ujian" required>
                                <label for="description">Tanggal Ujian</label>
                            </div>
