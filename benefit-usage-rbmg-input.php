<?php include 'header.php'; ?>
  ...
  <?php
    $id_rbmg=$_GET['id'];
    $sql = "SELECT * from op_rbmg where id_rbmg='$id_rbmg'";
                ...
                <script type='text/javascript'>
                    ...
                    var str = selectObject.value;  
                      if (str.length == 0) {
                        ...
                        xmlhttp.open("GET", "cekquota.php?type=5&idm=" + str+"&time="+time_stamp, true);
                        xmlhttp.send();
                      }
                    }
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <form method="POST" action="benefit-usage-rbmg-input-action.php" enctype="multipart/form-data">
                            <h6 class="mb-4">School Benefit Usage - RBMG</h6>
                            <div class="form-floating mb-3">
                                <select class="form-select" data-role="select" id="id_master" name="id_master" placeholder="Nama Sekolah"
                                    ...
                                    <?php
                                        $sql="select b.id_master,b.school_name,b.year from op_benefit a left join op_masterdata b on a.id_master=b.id_master where a.approval=1 and a.id_benefittype=5 order by school_name ASC";
                            ...
                            <div class="form-floating mb-3">
                                <input type="number" class="form-control" id="member1" name="member1" onchange="hitungJumlah()" <?php if($id_rbmg>0){ echo "value='".$rowa['rbmg1']."'";}?>
                                    placeholder="RBMG 1">
                                <label for="description">RBMG 1</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="number" class="form-control" id="member2" name="member2" onchange="hitungJumlah()" <?php if($id_rbmg>0){ echo "value='".$rowa['rbmg2']."'";}?>
                                    placeholder="RBMG 2">
                                <label for="description">RBMG 2</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="number" class="form-control" id="member" name="member" <?php if($id_rbmg>0){ echo "value='".$rowa['jumlah_peserta']."'";}?>
                            ...
                            <?php
                                if($id_rbmg>0)
                                {
                                    ...
                                    echo "<input type='hidden' name='id_rbmg' value='".$id_rbmg."'>";
                                }
                            ?>
