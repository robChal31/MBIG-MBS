                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="table_id">
                                    ...
                                    <tbody>
                                        <?php 
                                            $sql = "SELECT a.id_master,a.id_benefit,a.pelaksanaan,b.school_name, b.jenDok,c.ec_name,b.date as tanggalpk,expiredDate,b.year,keterangan,b.title,a.benefit_name, a.subbenefit,a.tanggal, a.description,a.qty FROM `op_simple_benefit` a left join op_masterdata b on a.id_master=b.id_master left join dash_ec c on c.id_ec=b.id_ec where a.type='".$type."' and isDeleted=0";
