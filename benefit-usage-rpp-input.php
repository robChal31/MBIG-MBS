<?php include 'header.php'; ?>
 ...
 <?php
    $id_rpp=$_GET['id'];
    $sql = "SELECT * from op_rpp where id_rpp='$id_rpp'";
                ...
                <script type='text/javascript'>
                    ...
                    var str = selectObject.value;  
                      if (str.length == 0) {
                        ...
                        xmlhttp.open("GET", "cekquota.php?type=10&idm=" + str+"&time="+time_stamp, true);
                        xmlhttp.send();
                      }
                    }
                </script>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <form method="POST" action="benefit-usage-rpp-input-action.php" enctype="multipart/form-data">
                            <h6 class="mb-4">School Benefit Usage - RPP</h6>
                            <div class="form-floating mb-3">
                                <select class="form-select" data-role="select" id="id_master" name="id_master" placeholder="Nama Sekolah"
                                    ...
                                    <?php
                                        $sql="select b.id_master,b.school_name,b.year from op_benefit a left join op_masterdata b on a.id_master=b.id_master where a.approval=1 and a.id_benefittype=10 order by school_name ASC";
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="description" name="description" <?php if($id_rpp>0){ echo "value='".$rowa['description']."'";} ?>
                                    placeholder="Deskripsi" required>
                                <label for="description">RPP Yang Diberikan</label>
                            </div>
                            ...
                            <?php
                                if($id_rpp>0)
                                {
                                    echo "<input type='hidden' name='id_rpp' value='".$id_rpp."'>";
