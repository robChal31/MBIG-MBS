<?php
    ...
    $selectedPrograms2  = ISSET($_POST['selectedPrograms']) ? $_POST['selectedPrograms'] : null;
    ...
    if($selectedPrograms2 == 'PK') {
        ...
        $selected_programs2 = implode("', '", $programs_temp);
    }else {
        $selected_programs2 = $selectedPrograms2;
    }
    ...
    <div class="col-12">          
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered" id="table_draft">
                ...
                <tbody>
                    <?php
                        $query_program = " AND a.program IN ('$selected_programs2') ";
