...
<?php
    $id_tkt=$_GET['id'];
    $sql = "SELECT * from op_tkt where id_tkt='$id_tkt'";
                ...
                <script type='text/javascript'>
                    ...
                    var str = selectObject.value;  
                      if (str.length == 0) {
                        ...
                        xmlhttp.open("GET", "cekquota.php?type=13&idm=" + str+"&time="+time_stamp, true);
                        xmlhttp.send();
                      }
                    }
                </script>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <form method="POST" action="benefit-usage-tkt-edit-action.php" enctype="multipart/form-data">
                            <h6 class="mb-4">School Benefit Usage - TKT / TKT CLIL</h6>
                            ...
                            <div class="form-floating mb-3">
                                <input type="date" class="form-control" id="tanggal" name="tanggal" <?php if($id_tkt>0){echo "value='".$rowa['training_date']."'";} ?>
                                    placeholder="Tanggal Training Training" required>
                                <label for="description">Tanggal Training</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="description" name="description" <?php if($id_tkt>0){echo "value='".$rowa['description']."'";} ?>
                                    placeholder="Description" required>
                                <label for="description">Description TKT</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="nama_peserta" name="nama_peserta" <?php if($id_tkt>0){echo "value='".$rowa['nama_peserta']."'";} ?>
                                    placeholder="Nama peserta">
                                <label for="description">Nama Peserta</label>
                            </div>
                            <div class="form-floating mb-3" id="containerss"> </div>
                            <input type='hidden' name='id_tkt' value='<?=$id_tkt?>'>
