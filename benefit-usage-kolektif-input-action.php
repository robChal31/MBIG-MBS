<?php
    ...
    for($i = 0; $i<$member ; $i++)
    {
       $sql = "INSERT INTO `op_kolektif` (`id_kolektif`, `id_master`, `training_date`, `training_name`, `nama_peserta`, `subjek_peserta`, `status`) VALUES 
       (NULL, '".$id_master."', '".$tanggal."', '".$judul."', '".$peserta[$i]."', '".$subjek[$i]."', '1');";
    ...
    //hitung kuota
    $sql = "update op_benefit set qty=qty-".$member." where id_master='$id_master' and id_benefittype=1;";
    mysqli_query($conn,$sql);
